...
class Blending:
    ...
    def get_image(self, image, face, face_box, upper_boundary_ratio=0.5, expand=1.2):
        # print(image.shape)
        # print(face.shape)
        ...
        x, y, x1, y1 = face_box
        # print(x1-x,y1-y)
        crop_box, s = self.get_crop_box(face_box, expand)
        ...
        blur_kernel_size = self.calc_dynamic_blur_kernel(ori_shape, image_size)
